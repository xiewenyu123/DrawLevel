...
//    QString m_color_set_SheetStyle = "min-width: 20px; min-height: 20px;max-width:20px; max-height: 20px;border-radius: 4px;"; //; background:#FC5660

//    color_name = "background:#FC5660";

//    colorset_lab->setStyleSheet(m_color_set_SheetStyle.append(color_name));
    ...
    color_btn->setStyleSheet("width: 40px;height: 20px;background: #FFFFFF;border: 1px solid #333333;border-radius: 4px;\
                      color: black; border-style: outset;}" // 按键本色
"QPushButton:hover{border: 1px solid #619FA9;;background-color:#FFFFFF;color: #619FA9}" ); // 鼠标停放时的色彩
...
//    hlayout_3->addWidget(colorset_lab);
